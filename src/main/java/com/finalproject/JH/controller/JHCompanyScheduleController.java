...
public class JHCompanyScheduleController {
    ...
    public String estimatetotalGET(Model model, @AuthenticationPrincipal User user,
        ...
        try {
            if(page == 0){
                return "redirect:/orca/schedulelist.do?page=1&departureport=" + departureport + "&arrivalport=" +arrivalport; 
            }
